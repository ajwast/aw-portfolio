...
router.post("/", utils_1.checkAdmin, projectController.createProject);
router.patch("/", utils_1.checkAdmin, projectController.updateProject);
router.delete("/:id", utils_1.checkAdmin, projectController.deleteProject);
